...
public class savingAccountTest {
    ...
    public void capitalGainsTaxIsIncludedInEndingBalance() {
        ...
        assertEquals(666, year.capitalGainsTaxIncurred(25));
        int expectedStratingBalanceAfterWithdrawls = 10000 - amountWithdrawn - expectedCapitalGainTax;
        assertEquals((int)(expectedStratingBalanceAfterWithdrawls * 1.10), year.endingBalance(25));
    }
